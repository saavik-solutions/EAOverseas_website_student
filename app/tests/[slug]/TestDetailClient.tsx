...
import { Info, Map, CheckCircle2, Globe, GraduationCap } from 'lucide-react';
...
export default function TestDetailClient({ slug }: TestDetailClientProps) {
             ...
             <div className="flex items-center gap-12 text-right">
                ...
                <div className="space-y-1">
                   ...
                   <div className="flex gap-2">
                      {test.stats.formats.map((f: string) => (
                     ...
                     {[1, 2, 3, 4, 5, 6].map(i => (
                       <div key={i} className="p-8 bg-bg-base/30 rounded-[2.5rem] border border-border border-dashed flex flex-col items-center justify-center gap-4 text-center">
                          ...
                          <div>
                             ...
                             <p className="text-[10px] font-black uppercase tracking-widest text-brand-primary mt-1">Min Score: {slug === 'ielts' ? '7.0' : '315'}</p>
                          </div>
                       </div>
                     ))}
                  </div>
